                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                    <div className="my-5 text-sm">
                        ...
                        <div className="flex items-center relative">
                            ...
                            <input {...register("fullName")} type="text" className='pl-10 py-3 mt-3 focus:outline-none border border-gray-200 focus:border-primary w-full rounded-md' autoFocus id="username" placeholder="Full Name" />
                        </div>
                    </div>
                    <div className="my-5 text-sm">
